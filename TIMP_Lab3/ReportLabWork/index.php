...
<head>
	<meta charset="UTF-8">
	<title>AirLogger-ReportLabWork</title>
			...
			<div class="col mt-1">
				...
				<table class="table shadow">
					<thead class="thead-dark">
						<tr>
							<th style="text-align: center; vertical-align: middle;">ID_Report</th>
							<th style="text-align: center; vertical-align: middle;">TitleReport</th>
							<th style="text-align: center; vertical-align: middle;">DateReport</th>
						...
						<tr>
							<td style="text-align: center; vertical-align: middle;"><?=$value['id_reportlw'] ?></td>
							<td style="text-align: center; vertical-align: middle;"><?=$value['titlereportlw'] ?></td>
							<td style="text-align: center; vertical-align: middle;"><?=$value['datereportlw'] ?></td>
							<td style="text-align: center; vertical-align: middle;"><?=$value['versionprojectlw'] ?></td>
							...
							<td style="text-align: center; vertical-align: middle;">
								<!--<a href="?edit=<?=$value['id_reportlw'] ?>" class="btn btn-success btn-sm" data-toggle="modal" data-target="#editModal<?=$value['id'] ?>"><i class="fa fa-edit"></i></a>-->
								<a href="?delete=<?=$value['id_reportlw'] ?>" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal<?=$value['id_reportlw'] ?>"><i class="fa fa-trash"></i></a>
	    ...
	    <div class="modal-content shadow">
	      ...
	      <div class="modal-body">
	        <form action="" method="post">
					...
					<input type="text" name="title" id="" placeholder = "TitleReport">
					<input type="number" name="idp" id="" placeholder = "ID_Project">
					<input type="number" name="ids" id="" placeholder = "ID_Student">
					<input type="text" name="daterep" id="" placeholder = "DateReport">
