				...
				<table class="table shadow">
					<thead class="thead-dark">
						<tr>
							...
							<th style="text-align: center; vertical-align: middle;">Firstname</th>
							<th style="text-align: center; vertical-align: middle;">Lastname</th>
							<th style="text-align: center; vertical-align: middle;">ID_Group</th>
						...
						<tr>
							...
							<td style="text-align: center; vertical-align: middle;"><?=$value['firstname'] ?></td>
							<td style="text-align: center; vertical-align: middle;"><?=$value['lastname'] ?></td>
							<td style="text-align: center; vertical-align: middle;"><?=$value['id_group'] ?></td>
							<td style="text-align: center; vertical-align: middle;">
								<a href="?delete=<?=$value['id_student'] ?>" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#deleteModal<?=$value['id_student'] ?>"><i class="fa fa-trash"></i></a>
								<a href="?edit=<?=$value['id_student'] ?>" class="btn btn-success btn-sm" data-toggle="modal" data-target="#editModal<?=$value['id_student'] ?>"><i class="fa fa-edit"></i></a>
	    ...
	    <div class="modal-content shadow">
	      ...
	      <div class="modal-body">
	        <form action="" method="post">
					...
					<input type="text" name="fn" id="" placeholder = "Firstname">
					<input type="text" name="ln" id="" placeholder = "Lastname">
					<input type="number" name="idg" id="" placeholder = "ID_Group">
